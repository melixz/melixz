...
Привет! Я программист из Москвы, специализирующийся на Python и Django, с опытом работы с PostgreSQL, SQLite, Docker, Git, и Linux. Обучаюсь на курсах SkillFactory, постоянно расширяя свои знания и навыки. Открыт к сотрудничеству и всегда ищу новые вызовы. Стремлюсь развиваться в веб-разработке, участвовать в значимых проектах и делиться своим опытом с сообществом. Для связи и сотрудничества доступен по email и Telegram. Следите за моими обновлениями и достижениями, ведь вместе мы сможем достичь большего! 🚀
